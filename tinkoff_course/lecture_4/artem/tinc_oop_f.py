...
class Stack():
    ...
    def mathematic(self, type):
        num_2 = int(self.values.pop(-1))
        num_1 = int(self.values.pop(-1))
        if type == '+':
            self.__add__(num_1, num_2)
        elif type == '-':
            self.__minus__(num_1, num_2)
        elif type == '*':
            self.values.append(num_1 * num_2)
        elif type == '/':
            self.values.append(num_1 // num_2)

    def __add__(self, num_1, num_2):
        self.values.append(str(num_1 + num_2))
    
    def __minus__(self, num_1, num_2):
        self.values.append(str(num_1 - num_2))

    def __mul__(self, num_1, num_2):
        self.values.append(str(num_1 * num_2))

    def __div__(self, num_1, num_2):
        self.values.append(str(num_1 // num_2))
